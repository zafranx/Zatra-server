...
router.post("/LookupList", async (req, res) => {
    try {
        ...
        // For Station_Speciality lookup
        console.log("lookup_type", req?.body?.lookup_type[0]);
        if (
            [
            ...
            console.log("stationSpecialityList", stationSpecialityList);
