...
// const assetAccessMiddleware = (req, res, next) => {
//   const userAssets = req.user.assetIds;
//   if (req.body.AssetID && !userAssets.includes(req.body.AssetID.toString())) {
//     return res.status(403).json({ message: "No access to this asset" });
//   }
//   next();
// };
